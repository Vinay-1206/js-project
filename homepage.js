...
async function addExpense(e) {
    ...
    try {
        await window.firebaseHelpers.addExpense(expense);
        expenseForm.reset();
        expenseDateInput.value = today;
    } catch (error) {
...
async function deleteExpense(id) {
    if (confirm('Are you sure you want to delete this expense?')) {
        try {
            await window.firebaseHelpers.deleteExpense(id);
        } catch (error) {
...
async function saveEditedExpense() {
    ...
    try {
        await window.firebaseHelpers.updateExpense(id, updated);
...
async function clearAllExpenses() {
    if (confirm('Are you sure you want to delete ALL expenses?')) {
        try {
            await window.firebaseHelpers.clearAllExpenses();
        } catch (error) {
...
function init() {
    ...
    unsubscribeFromExpenses = window.setupExpenseListener((expensesData) => {
